...
2.  ***(3 pts)*** Extract the `employees` and `customers` tables from the `company.db` database and join them using an inner join.
3.  ***(3 pts)*** Repeat the above step using a left join. How do the data sets compare?
